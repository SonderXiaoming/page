...
readable. For example, continue with [[a-good-start/first-post|the launch post]].

A standalone Wiki Link becomes an article card with its available metadata and
cover image:

[[a-good-start/first-post]]

```markdown
Read [[a-good-start/first-post|the launch post]] for more details.
